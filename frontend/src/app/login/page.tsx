    ...
    <div className="min-h-screen bg-[#1e2028] flex items-center justify-center font-sans overflow-hidden">
      ...
      <div className="relative w-full min-h-screen bg-[#1e2028] flex flex-col">
        ...
        <div className="absolute top-0 left-0 w-full p-10 flex items-center z-20">
          ...
          <div className="hidden sm:flex items-center gap-8 text-[#8a8d98] font-medium text-base">
        ...
        <div className="relative z-20 flex-1 flex flex-col justify-center px-10 sm:px-16 md:px-32 lg:px-40 w-full md:w-[60%] lg:w-[55%] pt-16">
          ...
          <p className="text-[#8a8d98] text-base font-bold tracking-[0.2em] uppercase mb-4">
            Secure Access
          </p>
          ...
          <div className="flex items-center gap-3 mb-12 text-2xl">
          ...
          <form onSubmit={handleLogin} className="w-full max-w-[500px] space-y-6">
            ...
            <div className="flex gap-5">
              ...
              <div className="flex-1 bg-[#282a31] rounded-2xl px-6 py-4 border border-transparent focus-within:border-[#1da1f2] transition-colors group relative">
                <label className="block text-base text-[#8a8d98] font-medium mb-1 uppercase tracking-wide">
                  Clearance Level
                </label>
                <input
                  type="text"
                  ...
                  className="w-full bg-transparent text-white text-2xl outline-none cursor-default font-medium"
                />
            ...
            <div className="w-full bg-[#282a31] rounded-2xl px-6 py-4 border border-[#1da1f2] shadow-[0_0_0_1px_rgba(29,161,242,0.3)] transition-colors group relative mt-4">
              <label className="block text-base text-[#1da1f2] font-medium mb-1 uppercase tracking-wide">
                Password
              </label>
              <input
                type="password"
                defaultValue="••••••••••••"
                className="w-full bg-transparent text-white text-2xl outline-none tracking-widest"
                required
              />
            ...
            <div className="flex items-center gap-5 pt-8">
              <button
                type="button"
                className="px-10 py-4 rounded-full bg-[#383a42] text-white text-2xl font-semibold hover:bg-[#40434c] transition-colors"
              >
                Request access
              </button>
              <button
                type="submit"
                disabled={loading}
                className="px-10 py-4 rounded-full bg-[#1da1f2] text-white text-2xl font-semibold hover:bg-[#1a91db] transition-colors shadow-[0_4px_14px_rgba(29,161,242,0.3)] flex items-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
              >
