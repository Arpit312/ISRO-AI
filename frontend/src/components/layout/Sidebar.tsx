  ...
  return (
    <>
      ...
      <div className="flex items-center gap-3 px-5 h-[var(--navbar-height)] border-b border-[var(--color-border)] shrink-0">
        <div className="relative flex items-center justify-center w-9 h-9 rounded-[var(--radius-md)] bg-[#14151a] shrink-0 overflow-hidden border border-white/10 shadow-[0_0_15px_rgba(29,161,242,0.15)] group">
